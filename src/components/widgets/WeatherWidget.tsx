 ...
 */
const WeatherWidgetComponent: React.FC<WidgetProps> = ({
  id,
  data,
  onDataChange,
}) => {
  ...
  const fetchWeatherData = async () => {
    ...
    try {
      ...
      toast.success("Weather updated", {
        description: `${weatherData.location} - ${Math.round(
  ...
  useEffect(() => {
    ...
    console.log("Weather widget init:", {
      lastFetched,
      shouldFetch,
      loading,
      hasWeather: !!weather,
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    handleSettingChange("showWeekly", checked)
                  }
                />
              </div>
            </div>
        ...
        {!loading && !error && weather && weatherDesc && (
          <div ref={ref} className="flex flex-col h-full justify-between">
            {!compact && (
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <span
                    className={cn(textSizes.small, "text-muted-foreground")}
                  >
                    {weather.location}
                  </span>
                </div>
            ...
            <div className="flex items-center justify-center flex-1">
              <div className="text-center">
                <div className={cn(textSizes.display, "mb-2")}>
                  {weatherDesc.icon}
                </div>
              ...
              <div className="grid grid-cols-2 gap-3 mt-4">
                <div className="flex items-center gap-2 p-2 rounded-md bg-muted/50">
                  ...
                  <div>
                    ...
                    <div className={cn(textSizes.small, "font-medium")}>
                      {convertSpeed(weather.windSpeed)}
                    </div>
                  </div>
                </div>
                <div className="flex items-center gap-2 p-2 rounded-md bg-muted/50">
            ...
            {settings.showWeekly &&
              ...
              forecast.length > 0 && (
                <div className="mt-4 pt-4 border-t border-border">
                  <div className={cn(textSizes.small, "font-medium mb-3")}>
                    7-Day Forecast
                  </div>
